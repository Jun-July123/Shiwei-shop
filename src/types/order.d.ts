...
// 40-4.2 order.ts定义提交订单请求参数类型OrderCreateParams
/** 提交订单 请求参数 */
...
// 41-2.4 配置订单返回详情类型
// 41-2.4.1 order.ts定义订单详情类型
export type OrderResult = {
  id: string /** 订单编号 */
  // 42-2.7 order.d.ts订单详情orderState的类型为OrderState枚举类型（需导入枚举类型）
...
// 41-7.2 order.ts定义物流信息类型OrderLogisticResult
/** 物流信息 返回值类型 */
